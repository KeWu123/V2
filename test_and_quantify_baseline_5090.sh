...
# Test both pretrain and self-train checkpoints from this exact Baseline folder,
# then create case-level and aggregate CSV/Markdown metric tables.
...
[[ -f "${CODE_DIR}/test_baseline.py" ]] || {
    echo "Missing test entry: ${CODE_DIR}/test_baseline.py" >&2
    exit 2
}
