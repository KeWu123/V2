...
# Test both checkpoints from the Baseline + UniMatch + RVTV experiment, then create
...
[[ -f "${CODE_DIR}/test_unimatch.py" ]] || {
    echo "Missing test entry: ${CODE_DIR}/test_unimatch.py" >&2
    exit 2
}
