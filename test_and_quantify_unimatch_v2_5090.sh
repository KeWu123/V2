...
# Test both checkpoints from the UniMatch V2 A0 experiment, then create
# case-level and aggregate CSV/Markdown metric tables. Metrics and
# post-processing are identical to the UniMatch baseline evaluation.
...
[[ -f "${CODE_DIR}/test_unimatch_v2.py" ]] || {
    echo "Missing test entry: ${CODE_DIR}/test_unimatch_v2.py" >&2
    exit 2
}
