...
parser.add_argument('--exp', type=str,
                    default='UniMatchV2_A0_label7_seed1337', help='experiment_name')
...
def self_train(args, pre_snapshot_path, snapshot_path):
    ...
    logging.info("{} iterations per epoch".format(len(trainloader)))
    logging.info(
        "UniMatch V2 A0: EMA+LCC teacher retained, tau=%.2f, "
        "comp_drop_dropout_prob=%.2f, branch_weights=(0.50, 0.50), "
        "strong_aug_prob=%.2f, blur_prob=%.2f, cutmix_prob=%.2f, "
        "ema_teacher_mode=%s",
        args.confidence_threshold, args.comp_drop_dropout_prob,
